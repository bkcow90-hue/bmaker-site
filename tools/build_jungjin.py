...
<main>
  <div class="wrap">
    ...
    <p>중진공은 신청 시스템 접수 → 서면·현장 평가 → 약정·실행 순서로 진행되며, 평가의 중심은 <b>숫자의 정합</b>입니다: 필요 금액의 산출 근거, 집행 계획(항목·금액·시기), 상환 계획이 서로 맞아야 합니다. 심사가 실제로 보는 5요소와 감점 포인트는 <a href="/gyehoekseo">사업계획서 가이드</a>에 정리했고, 중진공 단독 실행 건은 고객 동의·증빙이 확보되는 대로 기록에 추가합니다 — 저희는 문서로 증명할 수 있는 것만 올립니다.</p>
